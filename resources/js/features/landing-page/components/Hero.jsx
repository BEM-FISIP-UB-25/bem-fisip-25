...
const Hero = () => {
    return (
        <div className="flex flex-col relative  p-[2vw] items-center justify-center">
            {/* 2. Semua <Image> diganti menjadi <img>, src tetap sama */}
            ...
            <div className="flex flex-row justify-between gap-x-[5vw]  absolute top-0 left-0 p-[8vw]">
                <div className="flex flex-col gap-y-[3vw] relative">
                    ...
                    <div className="relative">
                        <img src={bgLeft} alt="bg-left" className="w-[50vw] " />
                        ...
                        <img src={ornament} alt="ornament" className="w-[2.5vw] absolute top-[41%] right-[2%]" />
                    ...
                    <div className="relative">
                        <img src={bgBlue} alt="bg-blue" className="w-[25vw] " />
                ...
                <div className="relative">
                    <img src={bgRight} alt="bg-right" className="w-[30vw] " />
                    <img src={logo} alt="logo" className="w-[27vw] absolute top-[15%] left-[5%]" />
