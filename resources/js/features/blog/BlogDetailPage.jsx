        ...
        >
            ...
            <div className="relative z-10">
                ...
                <motion.div
                    ...
                    className="relative w-full aspect-video overflow-hidden p-[5vw]"
                >
                    <img
                        src={post.image_url}
                        alt={post.title}
                ...
                <div className="px-[2vw] md:px-[4vw] lg:px-[8vw]">
                    ...
                    >
                        <h1 className="monumentExtendedUltrabold text-[#1d2466] text-[clamp(2.5vw,3.5vw,4vw)] tracking-tight leading-tight max-w-7xl mx-auto">
                            {post.title}
                        </h1>
                    </motion.div>
