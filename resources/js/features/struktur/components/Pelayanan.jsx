            ...
            <div className=" flex flex-col items-center w-full relative z-20 ">
                ...
                <EntryAnimation type="fade" duration={1}>
                    <div className="flex flex-col items-center justify-center gap-y-[2.5vw] md:gap-y-[1vw]  w-[90vw] md:w-[65vw]">
                        <img src={pelayanan} alt="pelayanan logo" className="w-[10vw]" />
                        ...
                        <div className="w-full flex flex-col items-center px-[2vw] mt-20">
                            ...
                            <div className="w-full max-w-7xl flex flex-col text-[#23235F] montserratBold gap-y-[3vw] justify-end p-6 md:p-[2.5vw] bg-white pt-16 md:pt-[5vw] mt-[-3.5vw] sm:mt-[-3vw] rounded-b-2xl z-0">
                                <div className="flex flex-col gap-y-[1.5vw]">
                                    ...
                                    <div className="flex flex-col text-black text-[clamp(0.9rem,1.5vw,1.5vw)]  gap-y-2">{["Berfokus pada pengadvokasian dan kesejahteraan mahasiswa berkoordinasi dengan Menko Pelayanan dan Jaringan Organisasi.","Bertanggung jawab dalam mentabulasi dan mengatasi isu permasalahan mahasiswa.","Bekerja sama dengan badan konseling mahasiswa untuk mensejahterakan mahasiswa FISIP.","Memberikan akses informasi beasiswa kepada mahasiswa FISIP.","Menjadi penghubung antara mahasiswa dan pihak dekanat untuk memastikan komunikasi yang efektif."].map((d, i) => (<div key={i} className="flex flex-row items-start gap-x-[1.5vw]"><h3 className="font-bold">{i + 1}.</h3><p>{d}</p></div>))}</div>
                                </div>
                                <div className="flex flex-col gap-y-[1.5vw]">
                    ...
                    <EntryAnimation type="slide" direction="up" delay={0.2} amount={0.1}>
                        <div className="w-full flex flex-col items-center px-[2vw] mt-20">
                            ...
                            <div className="w-full max-w-7xl flex flex-col text-[#23235F] montserratBold gap-y-[3vw] justify-end p-6 md:p-[2.5vw] bg-white pt-16 md:pt-[5vw] mt-[-3.5vw] sm:mt-[-3vw] rounded-b-2xl z-0">
                                <div className="flex flex-col gap-y-[1.5vw]">
                                    <h2 className="text-[clamp(1.5rem,2.5vw,2.5vw)]">ARAH STRATEGIS</h2>
                                    <div className="flex flex-col text-black text-[clamp(0.9rem,1.5vw,1.5vw)]  gap-y-2">{["Berfokus pada interkonektivitas LKM/Komunitas berkoordinasi dengan Menko Pelayanan dan Jaringan Organisasi.","Menyediakan wadah komunikasi bagi LKM dan komunitas dengan pihak dekanat.","Menjaring isu permasalahan dalam lingkup LKM dan komunitas.","Berperan melayani kebutuhan dan memberikan apresiasi kepada LKM dan komunitas.","Memberikan wadah memperkenalkan LKM dan komunitas FISIP UB."].map((d, i) => (<div key={i} className="flex flex-row items-start gap-x-[1.5vw]"><h3 className="font-bold">{i + 1}.</h3><p>{d}</p></div>))}</div>
                                </div>
                                <div className="flex flex-col gap-y-[1.5vw]">
                                    <h2 className="text-[clamp(1.5rem,2.5vw,2.5vw)]">PROGRAM KERJA</h2>
                                    <div className="flex flex-col text-black text-[clamp(0.9rem,1.5vw,1.5vw)] ">
