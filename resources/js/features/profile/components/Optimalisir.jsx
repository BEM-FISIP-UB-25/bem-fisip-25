...
const Card = ({ title, description }) => (
    <div className="bg-[#23235F] rounded-3xl p-[1.5vw] flex flex-col gap-y-[2vw] shadow-lg h-[35vw] w-[50vw]  flex-shrink-0">
        <div className="bg-[#FFA94D] rounded-2xl p-[1vw] flex items-center justify-center h-[12vw]">
            <h2 className="monumentExtendedUltrabold text-white text-[clamp(2.5vw,3vw,1.8rem)] flex items-center justify-center w-full tracking-[0.01em] text-center">
                {title}
            </h2>
        </div>
        <p className="text-white montserratBold text-[clamp(1.5vw,1.8vw,1.1rem)] text-justify leading-relaxed">
            {description}
        </p>
    </div>
);
    ...
    return (
        <div className="rounded-3xl bg-[#FF9A27] w-full relative shadow-[0px_-5px_13px_10px_rgba(0,0,0,0.25)] py-12">
            ...
            <div className="relative flex flex-col items-center gap-y-8 w-full">
                <h1 className="monumentExtendedUltrabold text-[#23235F] text-[clamp(3vw,4vw,2.5rem)] text-center px-4">
