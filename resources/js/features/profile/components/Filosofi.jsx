        ...
        <div className="rounded-3xl relative bg-[#FF9A27] w-full mt-[-3vw] relative shadow-[0px_-5px_13px_10px_rgba(0,0,0,0.25)] overflow-hidden">
            ...
            <div className="absolute flex flex-col items-center justify-center h-full gap-y-[4vw] w-full top-0 p-[2vw] h-full">
                ...
                <div className="flex flex-row items-center  justify-between gap-x-[2vw]">
                    ...
                    <EntryAnimation type="slide" direction="left" delay={0.2} duration={1} className="flex flex-col items-start justify-between h-full gap-y-[2vw] w-1/3 ">
                    ...
                    <EntryAnimation type="slide" direction="right" delay={0.2} duration={1} className="flex flex-col items-start justify-between h-full gap-y-[2vw] w-1/3 h-[30vw]">
